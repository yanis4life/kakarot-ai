...
function getAppCSS() { return `:root{--black:#0a0a0a;--dark-gray:#1a1a1a;--medium-gray:#2a2a2a;--light-gray:#f5f5f5;--white:#ffffff;--lemon-green:#84cc16;--font-family:Inter,system-ui,-apple-system,sans-serif}*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}html,body{height:100%;font-family:var(--font-family);background:var(--black);color:var(--white);-webkit-font-smoothing:antialiased;overflow-x:hidden;overflow-y:auto}body{overflow-y:auto}.hidden{display:none!important}.btn-primary{background:var(--lemon-green);color:var(--black);border:none;padding:10px 20px;border-radius:8px;font-size:14px;font-weight:600;cursor:pointer;transition:opacity .2s}.btn-primary:hover{opacity:.9}.btn-secondary{background:var(--medium-gray);color:var(--white);border:1px solid #333;padding:10px 20px;border-radius:8px;font-size:14px;cursor:pointer;transition:background .2s}.btn-secondary:hover{background:#333}.form-group{display:flex;flex-direction:column;gap:6px;margin-bottom:16px}.form-group label{font-size:13px;font-weight:500;color:#999}.form-group input,.form-group textarea,.form-group select{background:var(--dark-gray);border:1px solid #333;border-radius:8px;padding:10px 14px;color:var(--white);font-size:14px;outline:none;transition:border-color .2s}.form-group input:focus,.form-group textarea:focus,.form-group select:focus{border-color:var(--lemon-green)}.app-header{display:flex;align-items:center;justify-content:space-between;padding:0 20px;height:56px;background:var(--dark-gray);border-bottom:1px solid #2a2a2a;position:fixed;top:0;left:0;right:0;z-index:100}.header-left{display:flex;align-items:center;gap:12px;flex-shrink:0}.header-center{display:flex;align-items:center;gap:12px;flex:1;justify-content:center;min-width:0;padding:0 8px}.header-right{display:flex;align-items:center;gap:16px;flex-shrink:0}.logo{font-size:18px;font-weight:700;letter-spacing:-.5px;color:var(--white);text-decoration:none;white-space:nowrap}.menu-btn{background:none;border:none;color:var(--white);cursor:pointer;padding:4px;display:none;flex-shrink:0}.coin-display{display:flex;align-items:center;gap:6px;cursor:pointer;position:relative;padding:4px 10px;background:var(--medium-gray);border-radius:20px;font-size:13px;font-weight:600;white-space:nowrap;flex-shrink:0}.coin-tooltip{position:absolute;top:100%;right:0;margin-top:8px;background:var(--dark-gray);border:1px solid #333;border-radius:8px;padding:8px 12px;font-size:12px;white-space:nowrap;z-index:200}.user-avatar{position:relative;cursor:pointer;flex-shrink:0}.avatar-initials{width:32px;height:32px;border-radius:50%;background:var(--lemon-green);color:var(--black);display:flex;align-items:center;justify-content:center;font-size:13px;font-weight:700}.avatar-dropdown{position:absolute;top:100%;right:0;margin-top:8px;background:var(--dark-gray);border:1px solid #333;border-radius:8px;padding:4px;min-width:160px;z-index:200}.avatar-dropdown a{display:block;padding:8px 12px;color:var(--white);text-decoration:none;font-size:13px;border-radius:4px;transition:background .2s}.avatar-dropdown a:hover{background:var(--medium-gray)}.model-selector{background:var(--medium-gray);border:1px solid #333;border-radius:8px;padding:6px 12px;color:var(--white);font-size:13px;outline:none;cursor:pointer;min-width:140px;max-width:200px}.thinking-toggle{display:flex;align-items:center;gap:8px;flex-shrink:0}.toggle-switch{position:relative;width:36px;height:20px;display:inline-block;flex-shrink:0}.toggle-switch input{opacity:0;width:0;height:0}.toggle-slider{position:absolute;cursor:pointer;top:0;left:0;right:0;bottom:0;background:#333;border-radius:20px;transition:background .3s}.toggle-slider::before{content:"";position:absolute;height:16px;width:16px;left:2px;bottom:2px;background:var(--white);border-radius:50%;transition:transform .3s}.toggle-switch input:checked+.toggle-slider{background:var(--lemon-green)}.toggle-switch input:checked+.toggle-slider::before{transform:translateX(16px)}.toggle-label{font-size:12px;color:#999;white-space:nowrap}.overlay{position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,.5);z-index:50}.modal{position:fixed;top:0;left:0;right:0;bottom:0;display:flex;align-items:center;justify-content:center;z-index:150}.modal-content{background:var(--dark-gray);border:1px solid #333;border-radius:12px;padding:24px;min-width:400px;max-width:90vw}.modal-content h2{margin-bottom:16px;font-size:18px}.modal-actions{display:flex;gap:8px;justify-content:flex-end;margin-top:16px}.error-message{background:rgba(239,68,68,.1);border:1px solid rgba(239,68,68,.3);border-radius:8px;padding:10px 14px;color:#ef4444;font-size:13px;margin-top:12px}@media(max-width:767px){.app-header{padding:0 10px}.header-center{flex:0 1 auto;min-width:0}.model-selector{min-width:100px;max-width:150px;font-size:12px;padding:5px 8px}.coin-display{font-size:12px;padding:3px 8px}.sidebar{position:fixed;top:56px;left:0;bottom:0;z-index:100;transform:translateX(-100%);transition:transform .3s;width:85vw;max-width:320px}.sidebar.open{transform:translateX(0)}.menu-btn{display:block}.message{max-width:95%}.input-area{padding:10px 12px}.message-form{padding:6px 10px}.message-form textarea{font-size:14px}.modal-content{min-width:auto;width:90vw;padding:20px}}@media(max-width:480px){.app-header{padding:0 6px}.header-left .logo{font-size:14px}.model-selector{min-width:70px;max-width:120px;font-size:11px;padding:4px 6px}.coin-display{font-size:11px;padding:2px 6px}.header-right{gap:6px}.messages-container{padding:12px}.message{max-width:98%;padding:10px 12px;font-size:13px}}@media(max-width:360px){.model-selector{min-width:60px;max-width:90px;font-size:10px;padding:3px 4px}.header-left .logo{font-size:12px}.coin-display{font-size:10px;padding:2px 4px}.header-right{gap:4px}}`; }
...
function getChatCSS() { return `.app-body{display:flex;height:calc(100vh - 56px);margin-top:56px;overflow:hidden}.sidebar{width:280px;background:var(--dark-gray);border-right:1px solid #2a2a2a;display:flex;flex-direction:column;overflow:hidden;flex-shrink:0}.sidebar-header{padding:16px;border-bottom:1px solid #2a2a2a;display:flex;flex-direction:column;gap:4px}.btn-sidebar-action{width:100%;background:var(--medium-gray);border:1px solid #333;color:var(--white);padding:8px 12px;border-radius:8px;font-size:13px;cursor:pointer;transition:background .2s;text-align:center}.btn-sidebar-action:hover{background:#333}.workspace-list{flex:0 0 auto;max-height:200px;overflow-y:auto;padding:8px;border-bottom:1px solid #2a2a2a}.workspace-item{padding:8px 12px;border-radius:6px;font-size:13px;cursor:pointer;transition:background .2s;margin:1px 0}.workspace-item:hover{background:var(--medium-gray)}.workspace-name{font-weight:500;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.conversation-list{flex:1;overflow-y:auto;padding:8px}.conv-item{padding:8px 12px;border-radius:6px;font-size:13px;cursor:pointer;transition:background .2s;margin:2px 0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.conv-item:hover{background:var(--medium-gray)}.list-title{padding:8px 12px;font-size:11px;font-weight:600;color:#666;text-transform:uppercase;letter-spacing:1px}.main-content{flex:1;display:flex;flex-direction:column;overflow:hidden;min-width:0}.empty-state{flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;color:#666;text-align:center;padding:40px}.empty-state h2{font-size:20px;font-weight:600;color:#999}.empty-state p{font-size:14px}.chat-area{flex:1;display:flex;flex-direction:column;overflow:hidden;min-height:0}.messages-container{flex:1;overflow-y:auto;padding:20px;display:flex;flex-direction:column;gap:12px;min-height:0}.input-area{padding:16px 20px;border-top:1px solid #2a2a2a;background:var(--black);flex-shrink:0}.message-form{display:flex;gap:8px;align-items:flex-end;background:var(--dark-gray);border:1px solid #333;border-radius:12px;padding:8px 12px}.message-form textarea{flex:1;background:none;border:none;color:var(--white);font-size:14px;resize:none;outline:none;max-height:200px;font-family:inherit;min-height:24px}.send-btn{background:var(--lemon-green);border:none;border-radius:8px;padding:8px;cursor:pointer;color:var(--black);display:flex;align-items:center;justify-content:center;transition:opacity .2s;flex-shrink:0}.send-btn:hover{opacity:.9}.message{display:flex;flex-direction:column;max-width:80%;padding:12px 16px;border-radius:12px;font-size:14px;line-height:1.5;word-wrap:break-word;overflow-wrap:break-word}.message.user{background:var(--lemon-green);color:var(--black);align-self:flex-end;border-bottom-right-radius:4px}.message.assistant{background:var(--medium-gray);color:var(--white);align-self:flex-start;border-bottom-left-radius:4px}.message.system{background:transparent;color:#666;font-style:italic;font-size:12px;align-self:center;max-width:100%}@media(max-width:767px){.sidebar{position:fixed;top:56px;left:0;bottom:0;z-index:100;transform:translateX(-100%);transition:transform .3s;width:85vw;max-width:320px}.sidebar.open{transform:translateX(0)}.menu-btn{display:block}.message{max-width:92%;padding:10px 14px;font-size:13px}.messages-container{padding:12px;gap:8px}.empty-state{padding:24px}.empty-state h2{font-size:16px}.empty-state p{font-size:13px}}@media(max-width:480px){.sidebar{width:100vw;max-width:100%}.message{max-width:95%;padding:8px 12px;font-size:13px;line-height:1.4}.messages-container{padding:8px;gap:6px}.input-area{padding:8px 10px}.message-form{border-radius:10px;padding:6px 10px}.message-form textarea{font-size:14px}.send-btn{padding:6px}.empty-state h2{font-size:15px}.empty-state p{font-size:12px}}`; }

function getSettingsCSS() { return `.settings-main{display:flex;height:calc(100vh - 56px);margin-top:56px;overflow:hidden}.settings-nav{width:220px;background:var(--dark-gray);border-right:1px solid #2a2a2a;padding:16px 8px;display:flex;flex-direction:column;gap:2px;flex-shrink:0;overflow-y:auto}.settings-nav-item{padding:10px 12px;border-radius:6px;font-size:13px;color:#999;text-decoration:none;transition:all .2s}.settings-nav-item:hover{background:var(--medium-gray);color:var(--white)}.settings-nav-item.active{background:var(--medium-gray);color:var(--white)}.settings-content{flex:1;padding:32px;overflow-y:auto;min-width:0}.settings-tab{max-width:600px}.settings-tab h2{margin-bottom:24px;font-size:20px;font-weight:600}.api-keys-list{display:flex;flex-direction:column;gap:8px;margin-top:16px}.api-key-item{display:flex;align-items:center;justify-content:space-between;background:var(--medium-gray);padding:12px 16px;border-radius:8px;font-size:13px}.coin-info{background:var(--medium-gray);border-radius:12px;padding:24px;margin-bottom:20px;display:flex;flex-direction:column;gap:8px}.coin-info .balance{font-size:36px;font-weight:700;color:var(--lemon-green)}.coin-history{display:flex;flex-direction:column;gap:6px}.coin-history-item{display:flex;justify-content:space-between;padding:8px 12px;font-size:13px;color:#999;border-bottom:1px solid #2a2a2a}@media(max-width:767px){.settings-nav{display:none}.settings-content{padding:20px}.settings-tab{max-width:100%}.settings-tab h2{font-size:18px;margin-bottom:16px}.coin-info .balance{font-size:28px}}@media(max-width:480px){.settings-main{flex-direction:column}.settings-nav{display:flex;width:100%;flex-direction:row;overflow-x:auto;padding:8px 12px;gap:4px;border-right:none;border-bottom:1px solid #2a2a2a;flex-shrink:0}.settings-nav-item{white-space:nowrap;padding:6px 10px;font-size:12px}.settings-content{padding:16px}.api-key-item{flex-direction:column;align-items:flex-start;gap:8px}.coin-info{padding:16px}.coin-info .balance{font-size:24px}}`; }

function getWorkspacesCSS() { return `.workspaces-main{height:calc(100vh - 56px);margin-top:56px;padding:32px;overflow-y:auto}.workspaces-header{display:flex;align-items:center;justify-content:space-between;margin-bottom:24px}.workspaces-header h1{font-size:24px;font-weight:700}.workspaces-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(280px,1fr));gap:16px}.workspace-card{background:var(--dark-gray);border:1px solid #333;border-radius:12px;padding:20px;cursor:pointer;transition:border-color .2s}.workspace-card:hover{border-color:var(--lemon-green)}.workspace-card h3{font-size:16px;font-weight:600;margin-bottom:4px}.workspace-card p{font-size:12px;color:#666}.workspace-actions{display:flex;gap:8px;margin-top:12px}@media(max-width:767px){.workspaces-main{padding:20px}.workspaces-header h1{font-size:20px}.workspaces-grid{grid-template-columns:1fr;gap:12px}.workspace-card{padding:16px}}@media(max-width:480px){.workspaces-main{padding:16px 12px}.workspaces-header{flex-direction:column;align-items:stretch;gap:12px}.workspaces-header h1{font-size:18px}.workspaces-grid{gap:10px}.workspace-card{padding:14px}.workspace-card h3{font-size:15px}}@media(max-width:360px){.workspaces-main{padding:12px 8px}.workspaces-grid{gap:8px}.workspace-card{padding:12px}.workspace-card h3{font-size:14px}}`; }
